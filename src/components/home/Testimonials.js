    ...
    return(
        <>
            ...
            <div className="max-w-6xl px-4 py-24 content-center justify-center">
                <h1 className="text-3xl  text-center font-bold">Kullanıcı Yorumları</h1>
                        ...
                        return(
                            <div key={k} className="card w-full bg-base-100 shadow-xl">
                                <figure className="px-10 pt-10">
                                    <Image className="mask w-20 h-20 mask-circle object-cover" alt="foto" width="" height="" src={t.profilePic} />
                                </figure>
